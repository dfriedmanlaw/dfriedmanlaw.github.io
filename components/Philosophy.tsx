...
const Philosophy: React.FC = () => {
  return (
    <section id="philosophy" className="py-24 border-b relative overflow-hidden bg-tech-bg border-tech-border">
      ...
      <div className="max-w-[1440px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-16 relative z-10 items-start">
        ...
        <div className="pt-8 lg:col-span-8">
            ...
            <h3 className="text-3xl md:text-4xl lg:text-5xl mb-12 text-tech-text font-serif font-medium leading-tight">
                Results-driven. Simple process.<br />
                <span className="italic text-tech-muted">Here’s why to work with us.</span>
            </h3>
            
            <div className="space-y-12">
                {['Attention to detail', 'We make them pay your attorney’s fees', 'Easy online experience'].map((title, idx) => (
        ...
        <div className="relative lg:col-span-4 lg:sticky lg:top-24">
            {/* Bio Card */}
