...
const Navbar: React.FC = () => {
  ...
  return (
    <>
    <header 
      className={`fixed top-0 left-0 right-0 z-[110] transition-all duration-300 border-b ${styles.bg} py-4`}
    >
      <div className="max-w-[1440px] mx-auto px-6 flex items-center justify-between relative z-[70]">
        {/* Logo Area */}
        <Link to="/" className="flex flex-col group cursor-pointer relative z-[70]">
            <span className={`font-sans text-[10px] ${styles.primary} uppercase tracking-widest font-bold leading-none mb-1`}>
                Law Office of
            </span>
            <h1 className={`text-2xl font-serif font-bold tracking-tight ${styles.textMain} leading-none`}>
                David Friedman
            </h1>
        </Link>
        ...
        {/* Mobile Menu Icon */}
        <button 
            className={`md:hidden ${styles.textMain} p-2 hover:bg-black/5 rounded-md z-[70] relative`}
    ...
    {/* Mobile Menu Overlay */}
    {isMobileMenuOpen && (
        <div className="fixed inset-0 bg-white z-[100] pt-32 px-6 md:hidden overflow-y-auto flex flex-col">
